...
1. **system-prompt.md** -- The full system prompt (paste into GPT builder "Instructions" field)
2. **knowledge-file-1-scoring-rubric.md** -- Upload as knowledge file
3. **knowledge-file-2-behavioral-questions.md** -- Upload as knowledge file
4. **knowledge-file-3-career-matching.md** -- Upload as knowledge file
...
**Instructions:** Copy the ENTIRE contents of `system-prompt.md` and paste here.
...
**Knowledge:** Upload these three files:
